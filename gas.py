...
\x1b[0;33m║WELCOME TO MY TOOLS  [🔥 IQBAL R🔥].  ║

\x1b[0;33m║       #TOOL AUTHOR [IQBAL R] MAFIA BOSS. ║
...
\x1b[0;33m║#YOUTUBE : X-PAI.  ║

\x1b[0;33m║#FACEBOOK : NAME [X-CXD].       ║

\x1b[0;33m║#GITHUB : https://github.com/iqbal1506.   ║
...
def menu():
	...
	elif Bilal == "1" or IQBAL == "01":

		publik()

		method()

	elif Bilal == "2" or IQBAL == "02":

		follower()

		method()

	elif Bilal == "3" or  IQBAL == "03":

		massal()

		method()

	elif AWAIS == "4" or IQBAL == "04":
